package io.github.pintowar.opta.router.solver.timefold.domain.weights
...
class DepotAngleCustomerFactory : SelectionSorterWeightFactory<VehicleRoutingSolution, Customer> {
     ...
     *
     * This factory is used by Timefold Solver to sort customers based on their angle relative to the depot

    ...
    init {
        ...
        context("GET") {
            ...
            test("/api/vrp-problems with params") {
                ...
                client
                    .get()
                    .uri("/api/vrp-problems?page=1&size=5&q=sample")
                    .exchange()
                    .expectStatus()
                    .isOk
                    .expectHeader()
                    ...
                    .isEqualTo("sample-4")
                    .jsonPath("$.content[0].totalCapacity")
                    .isEqualTo(62)
                    .jsonPath("$.content[0].totalDemand")
                    .isEqualTo(31)

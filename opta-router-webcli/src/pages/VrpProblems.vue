  ...
  <vrp-page-layout :is-fetching="isFetching" :error="error">
    <main>
              ...
              <router-link :to="'/solve/' + instance.id" class="btn btn-circle">
                ...
                >
                  <g>
                    <path
                      class="st0"
                      d="M499.139,318.571l-37.178-5.407c-2.329-0.178-4.336-1.642-5.228-3.8l-12.054-29.086
      ...
      c10.92,10.92,16.934,25.446,16.934,40.89C396.027,356.874,390.014,371.39,379.093,382.328z"
                    ...
                    <path
                      class="st0"
                      d="M187.351,252.156c4.032-1.445,6.254-5.746,5.122-9.868l-5.898-28.854c-0.472-1.767,0.072-3.649,1.419-4.88

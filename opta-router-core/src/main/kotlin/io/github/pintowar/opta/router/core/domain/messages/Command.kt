...
data class CancelSolverCommand(
    val solverKey: UUID,
    val currentStatus: SolverStatus,
    val clear: Boolean = false
)

data class SolutionRequestCommand(
    val solutionRequest: VrpSolutionRequest,
    val clear: Boolean
)

data class SolutionCommand(
    val solutionRequest: VrpSolutionRequest
)